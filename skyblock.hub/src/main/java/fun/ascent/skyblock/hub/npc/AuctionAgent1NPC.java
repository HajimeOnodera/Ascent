...
public record AuctionAgent1NPC(Instance instance) implements NpcDefinition {
    @Override public String id() { return "hub_auction_agent_1"; }
    ...
    @Override public Pos position() { return new Pos(-33.5, 73, -17.5, 0, 0); }
