...
public final class SyphonEnchantment implements Enchantment {
    @Override
    public String getDescription(int level) {
        double pct = level * 0.1;
        return "Heals for " + pct + "% of your max health per 10% Critical Damage on critical hit.";
    }
