...
public final class ExecuteEnchantment implements Enchantment {
    @Override
    public String getDescription(int level) {
        double mult = level * 0.2;
        return "Increases damage dealt by " + mult + "% for each percent of health missing on target.";
    }
