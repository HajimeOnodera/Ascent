...
public final class SharpnessEnchantment implements Enchantment {
    private static final int[] DAMAGE_PERCENT = {5, 10, 15, 20, 30, 45, 65};

    @Override
    public String getDescription(int level) {
        return "Increases melee damage dealt by " + DAMAGE_PERCENT[level - 1] + "%.";
    }
