...
public final class SkyBlockEventInactiveEvent implements Event {

    private final Calendar.SkyBlockEvent skyBlockEvent;
    private final Calendar.SkyBlockTime time;

    public SkyBlockEventInactiveEvent(Calendar.SkyBlockEvent skyBlockEvent, Calendar.SkyBlockTime time) {
