...
public enum Stats {
    ...
    CRIT_CHANCE(true,"Crit Chance","§9☣",StatCategory.COMBAT ,"§9",30,0),
    CRIT_DAMAGE(true,"Crit Damage","§9☠",StatCategory.COMBAT ,"§9",50,0),
    BONUS_ATTACK_SPEED(true,"Bonus Attack Speed","§e⚔",StatCategory.COMBAT ,"§e",0,100),
     ...
     */
    SOULFLOW(false,"Soulflow","§c❁",StatCategory.HIDDEN ,"§c",0,0),
    OVERFLOW_MANA(false,"Overflow Mana","§c❁",StatCategory.HIDDEN ,"§c",0,0),
    ;
