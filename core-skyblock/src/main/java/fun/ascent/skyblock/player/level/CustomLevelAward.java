...
public enum CustomLevelAward {
    ACCESS_TO_COMMUNITY_SHOP(ItemStackCreator.getStackHead("Community Shop", "4e495b103ddd47701449ad7a34d908e8d2f08e0bd9476653d433c3bfc7c1b055"),
            "§bAccess to Community Shop"),
    ACCESS_TO_GARDEN(ItemStackCreator.getStackHead("Garden", "4778b434a258f7991825cabc965a56403c4d772e9628ce60164927e94b79d17"),
            "§2Access to the Garden"),
    ACCESS_TO_WARDROBE(ItemStackCreator.clearAttributes(ItemStack.builder(Material.LEATHER_CHESTPLATE)),
            "§aAccess to Wardrobe"),
    AUTO_PICKUP_BLOCK_AND_MOB_DROPS(ItemStackCreator.clearAttributes(ItemStack.builder(Material.DIAMOND_SWORD)),
            "§aAuto-Pickup Block and Mob Drops"),
    ACCESS_TO_BAZAAR(ItemStackCreator.getStackHead("Bazaar", "c232e3820897429157619b0ee099fec0628f602fff12b695de54aef11d923ad7"),
            "§6Access to Bazaar"),
    ACCESS_TO_WIZARD_PORTAL(ItemStackCreator.getStackHead("Wizard Portal", "838564e28aba98301dbda5fafd86d1da4e2eaeef12ea94dcf440b883e559311c"),
            "§dAccess to Wizard Portal"),
    DAILY_COINS_TRADE_LIMIT_OF_1B(ItemStackCreator.getStackHead("Daily Limit 1B", "740d6e362bc7eee4f911dbd0446307e7458d1050d09aee538ebcb0273cf75742"),
            "§aDaily Coins Trading Limit of 1B"),
    DAILY_COINS_TRADE_LIMIT_OF_10B(ItemStackCreator.getStackHead("Daily Limit 10B", "c43f12c8369f9c3888a45aaf6d7761578402b4241958f7d4ae4eceb56a867d2a"),
