...
public class QuestTalkToFarmhandAgain extends Quest {
    @Override public String getID() { return "talk_to_farmhand_again"; }
    @Override public String getName() { return "Talk to the Farmhand again"; }
