...
public class QuestTalkToLazyMiner extends Quest {
    @Override public String getID() { return "talk_to_lazy_miner"; }
    @Override public String getName() { return "Talk to the Lazy Miner"; }
