...
public class QuestTalkToFarmer extends Quest {
    @Override public String getID() { return "talk_to_farmer"; }
    @Override public String getName() { return "Talk to the Farmer"; }
    ...
    @Override public void onEnd(SkyblockPlayer player, Map<String, Object> customData, ActiveQuest quest) {
        ...
        player.getActiveProfileData().getQuestData().startQuest(QuestCollectWheat.class);
    }
