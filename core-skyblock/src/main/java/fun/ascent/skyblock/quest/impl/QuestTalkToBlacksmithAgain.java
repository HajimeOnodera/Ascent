...
public class QuestTalkToBlacksmithAgain extends Quest {
    @Override public String getID() { return "talk_to_blacksmith_again"; }
    @Override public String getName() { return "Talk to the Blacksmith again"; }
