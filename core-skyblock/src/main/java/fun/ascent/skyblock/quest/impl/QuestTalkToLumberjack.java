...
public class QuestTalkToLumberjack extends Quest {
    @Override public String getID() { return "talk_to_lumberjack"; }
    @Override public String getName() { return "Talk to the Lumberjack"; }
    ...
    @Override public void onEnd(SkyblockPlayer player, Map<String, Object> customData, ActiveQuest quest) {
        ...
        player.getActiveProfileData().getQuestData().startQuest(QuestBreakOaklog.class);
    }
