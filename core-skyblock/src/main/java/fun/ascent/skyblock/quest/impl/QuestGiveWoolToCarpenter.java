...
public class QuestGiveWoolToCarpenter extends Quest {
    @Override public String getID() { return "give_wool_to_carpenter"; }
    @Override public String getName() { return "Give Wool to the Carpenter"; }
