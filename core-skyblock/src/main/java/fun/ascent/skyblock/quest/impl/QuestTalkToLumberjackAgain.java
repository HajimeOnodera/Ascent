...
public class QuestTalkToLumberjackAgain extends Quest {
    @Override public String getID() { return "talk_to_lumberjack_again"; }
    @Override public String getName() { return "Talk to the Lumberjack again"; }
