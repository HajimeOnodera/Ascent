...
public class AdventurerShop extends ShopData {
    ...
    public AdventurerShop() {
        ...
        addItem(ItemRegistry.getItem("ZOMBIE_TALISMAN"),500,1);
        addItem(ItemRegistry.getItem("SKELETON_TALISMAN"),500,1);
        addItem(ItemRegistry.getItem("VILLAGE_TALISMAN"),2500,1);
        addItem(ItemRegistry.getItem("MINE_TALISMAN"),2500,1);
        addItem(ItemRegistry.getItem("INTIMIDATION_TALISMAN"),10000,1);
        addItem(ItemRegistry.getItem("SCAVENGER_TALISMAN"),10000,1);
    }
}
