package fun.ascent.common.protocol.objects.friend;
...
public class AreFriendsProtocolObject extends ProtocolObject<AreFriendsProtocolObject.AreFriendsMessage, AreFriendsProtocolObject.AreFriendsResponse> {
    @Override
    ...
    public Serializer<AreFriendsResponse> getReturnSerializer() {
        return new Serializer<>() {
            ...
            public String serialize(AreFriendsResponse value) {
                return Boolean.toString(value.areFriends);
            }
