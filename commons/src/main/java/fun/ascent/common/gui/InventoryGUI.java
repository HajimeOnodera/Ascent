...
public abstract class InventoryGUI {
    ...
    public InventoryGUI(String title, InventoryType size) {
        this.title = Component.text(title);
        this.size = size;
        this.items = Collections.synchronizedList(new ArrayList<>());
    }

    public InventoryGUI(Component title, InventoryType size) {
        this.title = title;
        this.size = size;
        this.items = Collections.synchronizedList(new ArrayList<>());
    }
    ...
    public void open(Player player) {
        ...
        InventoryGUI previouslyOpen = GUI_MAP.get(player.getUuid());
    ...
    public void suddenlyQuit(Inventory inventory, Player player) {}
     ...
     */
    public void updateItemStacks(Inventory inventory, Player player) {
        synchronized (items) {
            for (GUIItem item : items) {
    ...
    public record InventoryGUIOpenEvent(Player player, InventoryGUI opened, Inventory inventory) {
    }
